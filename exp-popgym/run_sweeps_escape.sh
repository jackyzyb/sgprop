...
RESULTS_DIR="${RESULTS_DIR:-results/sweeps_escape}"
...
algo_args=(
  "--model gru --env labyrinth_escape"
  "--model sparsenet --env labyrinth_escape --training-mode backprop"
  "--model sparsenet --env labyrinth_escape --training-mode sgprop  --adaptive-theta"
  "--model lstm --env labyrinth_escape"
)
